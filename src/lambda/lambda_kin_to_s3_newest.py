...
def invoke_next_lam(client_l):
    '''
    invoke the lambda function that extract data from s3 and put to redshift
    after cleaning
    '''
    client_l.invoke(FunctionName='lambda_s3_newest_to_redshift', InvocationType='Event')
    return ''
